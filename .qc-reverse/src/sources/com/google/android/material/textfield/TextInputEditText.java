...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet) {
        super(xy0.L(context, attributeSet, R.attr.editTextStyle, 0), attributeSet, 0);
        this.h = new Rect();
        f01.i(context, attributeSet, R.attr.editTextStyle, R.style.Widget_Design_TextInputEditText);
        int[] iArr = ys0.F;
        f01.l(context, attributeSet, iArr, R.attr.editTextStyle, R.style.Widget_Design_TextInputEditText, new int[0]);
