...
public class TriggerActionEditActivity extends wj {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        this.D = "shortActions".equals(stringExtra) ? this.C.b().k() : "longActions".equals(stringExtra) ? this.C.b().f() : null;
        try {
            h91Var = (h91) this.D.get(getIntent().getIntExtra("actionIndex", -1));
        } catch (Exception unused) {
        }
        this.E = h91Var;
        if (this.C == null || this.D == null || h91Var == null) {
            yb0.z("Something went wrong.", 1);
            finish();
        }
        Optional.ofNullable(v()).ifPresent(new a(18));
        if (bundle == null) {
            y30 y30VarW = w();
            y30VarW.getClass();
            ld ldVar = new ld(y30VarW);
            ldVar.i(R.id.settings, new j91(this.C, this.D, this.E));
            ldVar.e(false);
        }
    }
