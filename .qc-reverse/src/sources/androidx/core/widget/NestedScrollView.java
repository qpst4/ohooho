...
public class NestedScrollView extends FrameLayout implements qm0 {
    public static final float D = (float) (Math.log(0.78d) / Math.log(0.9d));
    public static final vj0 E = new vj0(3);
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, com.quickcursor.R.attr.nestedScrollViewStyle);
        this.d = new Rect();
        this.j = true;
        this.k = false;
        this.l = null;
        ...
        this.u = new int[2];
        this.v = new int[2];
        this.C = new bu(getContext(), new tb0(10, this));
        int i = Build.VERSION.SDK_INT;
        this.f = i >= 31 ? hx.a(context, attributeSet) : new EdgeEffect(context);
        this.g = i >= 31 ? hx.a(context, attributeSet) : new EdgeEffect(context);
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, F, com.quickcursor.R.attr.nestedScrollViewStyle, 0);
    ...
    private oy0 getScrollFeedbackProvider() {
        if (this.h == null) {
            this.h = new oy0(this);
        }
        return this.h;
    ...
    public final void addView(View view) {
        if (getChildCount() <= 0) {
            ...
            s1.f("ScrollView can host only one direct child");
        }
    }
    ...
    public float getVerticalScrollFactorCompat() {
        if (this.B == 0.0f) {
            ...
            if (!context.getTheme().resolveAttribute(R.attr.listPreferredItemHeight, typedValue, true)) {
                s1.f("Expected theme to define listPreferredItemHeight.");
                return 0.0f;
            }
    ...
    public final void j(int i) {
        if (getChildCount() > 0) {
            ...
            if (Build.VERSION.SDK_INT >= 35) {
                lm0.a(this, Math.abs(this.e.getCurrVelocity()));
            }
        }
    }
    ...
    */
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        if (!(parcelable instanceof nm0)) {
            super.onRestoreInstanceState(parcelable);
            return;
        }
        nm0 nm0Var = (nm0) parcelable;
        super.onRestoreInstanceState(nm0Var.getSuperState());
        this.y = nm0Var;
        requestLayout();
    }
    ...
    public final Parcelable onSaveInstanceState() {
        nm0 nm0Var = new nm0(super.onSaveInstanceState());
        nm0Var.b = getScrollY();
        return nm0Var;
    }
    ...
    */
    ...
    public final boolean t(EdgeEffect edgeEffect, int i) {
        ...
        float fI = fp1.i(edgeEffect) * getHeight();
    ...
    public final void u(int i, int i2, int i3, boolean z) {
        ...
        if (AnimationUtils.currentAnimationTimeMillis() - this.c > 250) {
            ...
            this.e.startScroll(getScrollX(), scrollY, 0, iMax, i3);
            if (z) {
                this.A.g(2, 1);
            } else {
                w(1);
    ...
    public final boolean v(MotionEvent motionEvent) {
        boolean z;
        EdgeEffect edgeEffect = this.f;
        if (fp1.i(edgeEffect) != 0.0f) {
            fp1.x(edgeEffect, 0.0f, motionEvent.getX() / getWidth());
            z = true;
        } else {
            z = false;
        }
        EdgeEffect edgeEffect2 = this.g;
        if (fp1.i(edgeEffect2) == 0.0f) {
            return z;
        }
        fp1.x(edgeEffect2, 0.0f, 1.0f - (motionEvent.getX() / getWidth()));
        return true;
    }
    ...
    public void setOnScrollChangeListener(mm0 mm0Var) {
    }
}
