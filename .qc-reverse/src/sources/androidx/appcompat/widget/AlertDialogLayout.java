        ...
        if (mode2 != 1073741824) {
            ...
            while (i8 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) lg0Var).width == -1) {
                        int i9 = ((LinearLayout.LayoutParams) lg0Var).height;
                        ((LinearLayout.LayoutParams) lg0Var).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i7, 0);
                        ((LinearLayout.LayoutParams) lg0Var).height = i9;
                    }
                }
                i8++;
