...
public final class gl0 extends v8 implements MenuItem {
    public final n31 c;
    public Method d;

    public gl0(Context context, n31 n31Var) {
        super(context);
        if (n31Var != null) {
            this.c = n31Var;
        } else {
    ...
    public final View getActionView() {
        ...
        return actionView instanceof el0 ? (View) ((el0) actionView).b : actionView;
    }
    ...
    public final MenuItem setActionProvider(ActionProvider actionProvider) {
        dl0 dl0Var = new dl0(this, actionProvider);
    ...
    public final MenuItem setActionView(int i) {
        n31 n31Var = this.c;
        n31Var.setActionView(i);
        View actionView = n31Var.getActionView();
        if (actionView instanceof CollapsibleActionView) {
            n31Var.setActionView(new el0(actionView));
        }
        return this;
    }
    ...
    public final MenuItem setOnActionExpandListener(MenuItem.OnActionExpandListener onActionExpandListener) {
        this.c.setOnActionExpandListener(onActionExpandListener != null ? new fl0(this, onActionExpandListener) : null);
        return this;
    }

    @Override // android.view.MenuItem
    public final MenuItem setOnMenuItemClickListener(MenuItem.OnMenuItemClickListener onMenuItemClickListener) {
        this.c.setOnMenuItemClickListener(onMenuItemClickListener != null ? new k31(this, onMenuItemClickListener) : null);
        return this;
    }
