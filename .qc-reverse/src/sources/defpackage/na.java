...
public final class na {
    ...
    public final int c(RectF rectF) {
        ...
        if (length == 0) {
            s1.f("No available text sizes to choose from.");
            return 0;
        }
        int i = length - 1;
        int i2 = 0;
        ...
        while (true) {
            ...
            StaticLayout staticLayoutA = ja.a(charSequence, (Layout.Alignment) e(textView, Layout.Alignment.ALIGN_NORMAL, "getLayoutAlignment"), Math.round(rectF.right), maxLines, this.i, this.h, this.k);
