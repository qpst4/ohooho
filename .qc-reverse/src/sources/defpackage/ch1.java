...
public final class ch1 {
    ...
    static {
        float[] fArr = tk0.c;
        float fQ = (float) ((((double) tk0.Q()) * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = tk0.a;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        ...
        float f9 = 1.0f / ((5.0f * fQ) + 1.0f);
        float f10 = f9 * f9 * f9 * f9;
        float f11 = 1.0f - f10;
        float fCbrt = (0.1f * f11 * f11 * ((float) Math.cbrt(((double) fQ) * 5.0d))) + (f10 * fQ);
        float fQ2 = tk0.Q() / fArr[1];
        double d2 = fQ2;
        ...
        k = new ch1(fQ2, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * fPow, fPow, fPow, 0.69f, 1.0f, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }

    public ch1(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f = f;
        this.a = f2;
        this.b = f3;
        this.c = f4;
