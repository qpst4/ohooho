...
public abstract class xu0 {
    ...
    public static void f(AccessibleObject accessibleObject) {
        try {
            ...
            StringBuilder sbM = l11.m("Failed making ", d(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.");
            sbM.append(e(e));
            throw new rd0(sbM.toString(), e);
        }
    }
}
