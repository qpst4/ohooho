...
public abstract class pj1 {
    public static final t01 a = new t01(0);
    public static Locale b;

    public static String a(Context context) {
        String packageName = context.getPackageName();
        try {
            Context context2 = cj1.a(context).a;
    ...
    public static String b(Context context, int i) {
        ...
        if (i == 2) {
            return xy0.s(context) ? resources.getString(R.string.common_google_play_services_wear_update_text) : resources.getString(R.string.common_google_play_services_update_text, strA);
        }
        if (i == 3) {
    ...
    public static String e(Context context, String str) {
        ...
        synchronized (t01Var) {
            try {
                ...
                String str2 = (String) t01Var.get(str);
                if (str2 != null) {
                    return str2;
                }
                int i = b70.c;
