...
class OCREngine(
    ...
    detModelFile: String? = null,
    recModelFile: String? = null,
    recConfigFile: String? = null,
) {
    ...
    init {
        val configured = try {
            if (detModelFile != null && recModelFile != null && recConfigFile != null) {
                ortManager.loadModelsFromFiles(detModelFile, recModelFile)
                ModelConfig.parseFile(recConfigFile)
            } else {
